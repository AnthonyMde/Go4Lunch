...
interface GooglePlacesApi {
    ...
    @GET("maps.googleapis.com/maps/api/place/details/json?key=$API_KEY_GOOGLE_PLACES")
    fun getPlaceDetail(@Query("placeid") placeId: String, @Query("fields") fields: String): Call<Places>

    @GET("maps.googleapis.com/maps/api/place/photo?key=$API_KEY_GOOGLE_PLACES")
